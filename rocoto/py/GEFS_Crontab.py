def create_crontab(dicBase, OnlyForTest=False, cronint=5):
    ...
    if system == 'wins' or system == 'hera':
        ...
        bash_file.write("\n")
        bash_file.write("rsync -ah --progress  /gpfs/dell6/ptmp/Xianwu.Xue/o/gefs_v12_1_0_retro_JulAug_defaultValue/com/output /gpfs/dell6/emc/modeling/noscrub/Xianwu.Xue/GEFS/gefs_v12_1_0_retro_JulAug_defaultValue/\n")
