...
case ${cmodel} in 
  ...
  ukmet) set +x                                         ; 
       ...
       echo " "                                         ;
       set -x                                           ;
       ukmetdir=/com/ukmet/prod/ukmet.${PDY}              ;
       ukmetgfile=ukmet.t${CYL}z.ukmet                  ;
       ukmetifile=ukmet.t${CYL}z.ukmeti                 ;
       COM=/com/ukmet/${envir}/ukmet.${PDY}               ;
       fcstlen=72                                       ;
  ...
  ece) set +x                                           ;
       ...
       #ecedir=${ecedir:-/com/mrf/prod/wsr.${PDY}}                  ;
       ecedir=${ecedir:-/com/gens/prod/ecme.${PDY}}                  ;
       ecegfile=                                        ;
       eceifile=                                        ;
