...
/* Grib Api version */
#define GRIB_API_MAIN_VERSION 1.9.16
...
#define GRIB_API_REVISION_VERSION 16

/* Directory where definition files are */
#define GRIB_DEFINITION_PATH "/gpfs/dell1/nco/ops/nwpara/wsr.v3.1.0.1/libs/ecmwf_grib_api-1.9.16/share/definitions"
...
#define GRIB_SAMPLES_PATH "/gpfs/dell1/nco/ops/nwpara/wsr.v3.1.0.1/libs/ecmwf_grib_api-1.9.16/share/samples"

/* Directory where templates are */
#define GRIB_TEMPLATES_PATH "/gpfs/dell1/nco/ops/nwpara/wsr.v3.1.0.1/libs/ecmwf_grib_api-1.9.16/share/samples"
