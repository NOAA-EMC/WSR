...
xstart = xstart - 0.5
ystart = ystart - 0.25
title3='NCEP/UM ETKF based on 'mem'-member 'ensdate' 'ensemble' ensemble. Best flight tracks:'
'set string 1 bc 6'
'set strsiz 'hsiz' 'vsiz
...
'set string 2'
'draw string 10.1 'ystart' 'fl1

'set strsiz 0.11 0.15'
'set string 4'
'draw string 10.4 'ystart' 'fl2

'set strsiz 0.11 0.15'
'set string 39'
'draw string 10.7 'ystart' 'fl3
