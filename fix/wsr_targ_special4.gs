...
*title='NCEP ETKF. Observation Time 'hr1'. Verification Time 'hr2'.'
...
*title2='Case 'case'  Obs. time: 'hr1'  Verif. time 'hr2'  VR: 'vrlat'N, 'vrlon'W, 'radvr'km radius  Verif. var.: 'vnormgr' '  
title2='VR: 'vrlat'N, 'vrlon'W, Verif. time 'hr2'  Obs. time: 'hr1' (VR radius: 'radvr'km)   Verif. var.: 'vnormgr' '  
ystart = ystart - 0.25
'set string 1 bc 6'
'set strsiz 'hsiz' 'vsiz
